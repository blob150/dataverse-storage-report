...
var c = new ServiceClient("AuthType=OAuth;Url=https://bprocidatest.crm.dynamics.com;LoginPrompt=Auto;TokenCacheStorePath=" + System.IO.Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.UserProfile), ".pac", "cache"));
